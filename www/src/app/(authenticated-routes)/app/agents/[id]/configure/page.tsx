                        ...
                        <div className="flex items-center justify-between gap-2">
                            <div className="flex-[3] space-y-1">
                                ...
                                <p className="text-sm text-neutral-500">
                                    Allow others to interact with this agent by
                                    embedding it on your website. Your agent
                                    will remain privat unless this is turned on.
                                </p>
                            </div>
                    ...
                    <form className="space-y-10">
                        <fieldset className="space-y-2">
                            ...
                            <p className="text-sm text-neutral-600">
                                The agent will reach out to the contacts you
                                upload via the specified communication channel
                                per the outreach frequency
                            </p>
