            ...
            <section className="items-center justify-center flex h-[calc(100vh-70px)] px-5">
                <div className="text-center space-y-10">
                    <h1 className="text-[1.6rem] md:text-[4rem] w-full max-w-[1000px] mx-auto leading-[1.2] bold-heading">
                        Fire Your Sales Team. Hire a Voice Agent (It Works
                        Weekends).
                    </h1>
                    <p className="text-neutral-600 max-w-[700px] mx-auto leading-[1.7] md:text-[20px]">
                        Why pay monthly huge salaries when you can deploy an AI
                        Sales Agent in seconds for less than $50/mo? Let it cold
                        call, follow up, and close deals while you&apos;re
                        asleep (or on a beach). No leave/sick days. Just pure
                        hustle, 24/7.
                    </p>
